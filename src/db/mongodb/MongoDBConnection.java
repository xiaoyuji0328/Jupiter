...
public class MongoDBConnection implements DBConnection{
	...
	public Set<String> getFavoriteItemIds(String userId) {
		...
		if (iterable.first().containsKey("favorite")) {
			@SuppressWarnings("unchecked") //强制转换下边会有warning
	...
	public void saveItem(Item item) {
		...
		FindIterable<Document> iterable = db.getCollection("items").find(eq("item_id", item.getItemId())) ; //see if already exists
		if (iterable.first() == null) { //then insert
